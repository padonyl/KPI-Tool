 ...
 *
 * Vstup do aplikace je ZÁMĚRNĚ tady, a ne v horní firemní liště: firemní web
 * je o Padonylu, přihlášení patří k nástroji (rozhodnutí uživatele
 * 2026-09-18). Kdo je přihlášený, dostane rovnou odkaz do appky.
 */
export function ProductNav({ prihlasen }: { prihlasen: boolean }) {
  return (
